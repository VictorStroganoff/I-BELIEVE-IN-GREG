const STEAM_MB = Java.loadClass('com.gregtechceu.gtceu.common.machine.multiblock.steam.SteamParallelMultiblockMachine');
...
GTCEuStartupEvents.registry('gtceu:machine', event => {
	// heating_basin
	event.create('heating_basin', 'multiblock', m => new STEAM_MB(m))
		...
		.pattern(definition => FactoryBlockPattern.start()
			...
			.build())
		.workableCasingRenderer("gtceu:block/casings/solid/machine_casing_solid_steel", "gtceu:block/multiblock/multiblock_workable", false);
	...
	event.create('steam_fluid_solidifier', 'primitive')
		...
		.pattern(definition => FactoryBlockPattern.start()
			...
			.where('C', Predicates.blocks('gtceu:steel_brick_casing'))
			.build())
		.workableCasingRenderer("gtceu:block/casings/solid/machine_casing_solid_steel", "gtceu:block/machines/fluid_solidifier/", false);
});